<template>
  <footer class="bg-[#24304a] text-[#f4da7b] px-6 py-10 md:px-16">
    <div class="max-w-12xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-sm">
      <div class="space-y-4">
        ...
        <div class="flex items-center gap-2 text-white">
          ...
          <span>+998 (91) 711-70-00</span>
        </div>
        <div class="flex items-center gap-2 text-white">
          <i class="bx bx-envelope text-lg"></i>
          <div class="flex flex-col">
            <span>info@veniki.uz</span>
      ...
      <div class="space-y-4">
        ...
        <form class="flex gap-2" @submit.prevent="sendMessage">
          ...
          <button
            ...
            :disabled="loading"
            required
            class="bg-[#a8e66f] cursor-pointer text-black px-4 hover:bg-lime-400 transition"
          >
