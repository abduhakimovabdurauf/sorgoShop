    ...
    <div class="max-w-screen flex flex-wrap items-center overflow-x-hidden justify-between mx-auto px-6 lg:px-24 py-4">
      ...
      <div class="flex items-center md:order-2 space-x-1 md:space-x-0 rtl:space-x-reverse">
        ...
        >
            ...
            <ul class="py-2 font-medium" role="none">
                ...
                <li>
                <a href="#" @click.prevent="changeLanguage('uz')"
                    class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">
                    <div class="inline-flex items-center">
                    {{ t('navbar.uzbek') }}
                    </div>
      ...
      <div class="items-center justify-between hidden w-full lg:flex md:w-auto md:order-1" id="navbar-language">
        <ul
          ...
          <li>
            <a href="#" class="block py-2 px-3 text-gray-900 rounded-sm md:bg-transparent md:p-0" aria-current="page">
              {{ t('navbar.home') }}
            </a>
          </li>
          <li>
            <a href="#" class="block py-2 px-3 md:p-0 text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:hover:text-gray-600">
              {{ t('navbar.product') }}
            </a>
          </li>
          <li>
